...
namespace ShipmentTracking.WebUI.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                var claims = new List<Claim>
                {
                    ...
                    new Claim("jwt_token", token) // Cüzdana bileti koyuyoruz!
                };
        ...
        public async Task<IActionResult> Register(RegisterViewModel registerViewModel)
        {
            ...
            AttachToken(); // 🛑 POSTACIYA BİLETİ TAKTIK!
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                return RedirectToAction("PersonnelList", "Auth"); // Kayıttan sonra personel listesine dönmek daha mantıklı
            }
            else
            {
